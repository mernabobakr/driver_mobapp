...
const List<Slide> slideList = [
  ...
  Slide(
    ...
    description:
        'Much financial stress? you do not have job?tWe totally understand! We offer you a fixed salary every month. The salary starts from 2500 and up to 5,350 or more depending on the distance of the trip. ',
  ),
  Slide(
